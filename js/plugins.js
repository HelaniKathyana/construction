...
$(function() {
  ...
  emailjs.init('GYWwk-TMkQNkWCX_r');

  $('#contact-form').submit(function (e) {
    e.preventDefault(); // Prevent default form submission

    // Use Email.js to send form data
    emailjs.sendForm('service_3hohnk5', 'template_z92odcj', this)
        .then(function (response) {
            // Success feedback
            $('.form-messege').removeClass('error').addClass('success');
            $('.form-messege').text('Email sent successfully.');
            ...
            $('.form-messege').text('Oops! An error occurred: ' + error.text);
        });
});
  ...
  //     $(formMessages).text('Email sent successfully.');
